...
# ENV variables for security (set these in Render dashboard)
BOT_TOKEN = os.environ.get("BOT_TOKEN")
UPI_ID = os.environ.get("UPI_ID")
DESIGNER_ID = int(os.environ.get("DESIGNER_ID", "0"))  # Must be set as integer

DP_IMAGES = os.listdir("dp_catalog") if os.path.exists("dp_catalog") else []
NAME_IMAGES = os.listdir("name_catalog") if os.path.exists("name_catalog") else []
USER_STATE = {}
